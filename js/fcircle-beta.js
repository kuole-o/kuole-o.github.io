      ...
      for (var i = start;i<endFor;i++){
        ...
        <div class="cf-article">
          ...
          <div class="cf-article-avatar no-lightbox flink-item-icon">
            <img class="cf-img-avatar avatar" src="${item.avatar}" alt="" onerror="this.src='${fdata.error_img}'; this.onerror = null;">
    ...
    var showHtml = `
        <div class="cf-overshow">
          <div class="cf-overshow-head">
            <img class="cf-img-avatar avatar" src="${userinfo.avatar}" alt="" onerror="this.src='${fdata.error_img}'; this.onerror = null;">
